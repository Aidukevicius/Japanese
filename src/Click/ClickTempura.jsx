...
import ClickTempura from '../assets/ClickTempura.png'

  export default function Example() {
    return (
      <div className="fixed mt-20 inset-0 flex items-center justify-center boorder-20px z-10 "
      >
      ...
      <Card className="w-full justify-center m-auto max-w-[40rem] shadow-lg bg-white border-4 border-black">
        ...
        <CardBody>
          ...
          A flawless fusion of crispy and succulent delights. Tender shrimp are coated in a light, golden batter, creating a tantalizing contrast. With each bite, experience the satisfying crunch followed by the juicy sweetness of the shrimp. It's a culinary harmony that embodies Japanese perfection.
          </Typography>
