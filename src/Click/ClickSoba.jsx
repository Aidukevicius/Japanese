import {
  ...
  import ClickSoba from '../assets/ClickSoba.png'
    ...
    return (
      ...
      <Card className="w-full justify-center m-auto max-w-[40rem] shadow-lg bg-white border-4 border-black">
        ...
        <CardBody>
          ...
          Japanese dish that combines meticulously handcrafted buckwheat soba noodles with succulent grilled duck or chicken, a colorful medley of seasonal vegetables, and a flavorful broth. With its vibrant presentation and harmonious flavors, Yūhi Soba captures the breathtaking beauty of a sunset, offering a truly memorable dining experience.
          </Typography>
          <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
            <Tooltip content="45min">
