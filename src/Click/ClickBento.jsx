import {
  ...
  import ClickBento from '../assets/ClickBento.png'
  ...
  export default function Example() {
    return (
      ...
      <Card className="w-full justify-center m-auto max-w-[40rem] shadow-lg bg-white border-4 border-black z-9999">
        ...
        <CardBody>
          ...
          A flavorful and balanced meal in a Bento box. It includes grilled chicken in teriyaki sauce, steamed rice, stir-fried vegetables, cucumber salad, and sushi rolls. A delightful and convenient choice for a satisfying lunch.
          </Typography>
          <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
            <Tooltip content="1h 30min">
            ...
            <Tooltip content="Expert Difficulty">
