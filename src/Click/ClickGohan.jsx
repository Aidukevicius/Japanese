    ...
    return (
      ...
      <Card className="w-full justify-center m-auto max-w-[40rem] shadow-lg bg-white border-4 border-black">
        ...
        <CardBody>
          ...
          A visually captivating Japanese rice dish. Premium ingredients and vibrant colors intertwine to create a feast for the eyes. With each bite, savor the harmonious fusion of flavors and textures, a true masterpiece of culinary art. Let Temari Gohan transport you to the delightful world of Japanese cuisine.
          </Typography>
          <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
            <Tooltip content="30min">
            ...
            <Tooltip content="Easy Difficulty">
