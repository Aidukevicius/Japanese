import {
  ...
  import ClickKatsudon from '../assets/ClickKatsudon.png'
      ...
      <Card className="w-full justify-center m-auto max-w-[40rem] shadow-lg bg-white border-4 border-black">
        ...
        <CardBody>
          <div className="mb-3 flex items-center justify-between">
            ...
            Tokyo-style Katsudon
            </Typography>
          </div>
          <Typography color="black" className='font-Noto'>
          A flawlessly fried pork cutlet on a bed of aromatic rice, smothered in a delectable soy-based sauce. With its perfect balance of crispiness, tenderness, and flavors, it's a culinary delight that captures the essence of Japanese cuisine.
          </Typography>
